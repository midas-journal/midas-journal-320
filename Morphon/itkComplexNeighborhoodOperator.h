/*=========================================================================
  ...
  Module:    $RCSfile: itkComplexNeighborhoodOperator.h,v $
  Language:  C++
...
#ifndef __itkComplexNeighborhoodOperator_h
#define __itkComplexNeighborhoodOperator_h
...
namespace itk {
/** \class ComplexNeighborhoodOperator
...
class ITK_EXPORT ComplexNeighborhoodOperator
  : public Neighborhood<TPixel, VDimension, TAllocator>
{
public:
  /**  Standard class typedefs. */ 
  typedef ComplexNeighborhoodOperator Self;
  ...
  /** Constructor. */
  ComplexNeighborhoodOperator()
    {  m_Direction = 0;  }

  /** Copy constructor */
  ComplexNeighborhoodOperator(const Self &orig)
 ...
 /** Assignment operator. */
  ...
  virtual void PrintSelf(std::ostream& os, Indent i) const
    {
      os << i << "ComplexNeighborhoodOperator { this=" << this
...
protected:
  ...
  typedef std::vector<ComplexType> CoefficientVector;
...
#define ITK_TEMPLATE_ComplexNeighborhoodOperator(_, EXPORT, x, y) namespace itk { \
  _(2(class EXPORT ComplexNeighborhoodOperator< ITK_TEMPLATE_2 x >)) \
  namespace Templates { typedef ComplexNeighborhoodOperator< ITK_TEMPLATE_2 x > \
                                                  ComplexNeighborhoodOperator##y; } \
  }
...
#if ITK_TEMPLATE_TXX
# include "itkComplexNeighborhoodOperator.txx"
#endif
